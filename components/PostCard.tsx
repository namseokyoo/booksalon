...
const PostCard: React.FC<PostCardProps> = ({
  ...
  if (bookTitle) {
    return (
      ...
      >
        <p className="text-xs text-muted-foreground truncate mb-0.5">[{bookTitle}]</p>
        <div className="flex items-center justify-between">
          <h3 className="font-medium text-foreground text-sm truncate flex-1 min-w-0 mr-2">{title}</h3>
